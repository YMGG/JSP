...
public class add extends HttpServlet { private static final long serialVersionUID = 1L;
...
Hero hero = manager.findOne(id);//使用manager对象和刚才传递过来的id，获取英雄 request.setAttribute("hero", hero);//将获取到的英雄放到request里面去。
