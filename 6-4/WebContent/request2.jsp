...
<body>
 <h3>第6章测试题</h3>
 <hr>
 <from action="requestHandle.jsp" method="get">
   1.response对象的 setHeader(String name,String value)方法作用是( ).<br>
   ...
   <input type="radio" name="2" value="D">getLastAccessdTime()<br>
   3.能清除缓冲区中的数据，并且打数据输出到客户端是out对象中的方法是( ).<br>
