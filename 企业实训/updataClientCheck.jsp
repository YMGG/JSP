...
new String(request.getParameter("clientTelephone")
		 .getBytes("ISO-8859-1"),"utf-8");
String clientAddress=
new String(request.getParameter("clientAddress")
		 .getBytes("ISO-8859-1"),"utf-8");
String clientEmail=
new String(request.getParameter("clientEmail")
		 .getBytes("ISO-8859-1"),"utf-8");
Connection con=null;
Statement st=null;
if(clientName.equals("")){
	response.sendRedirect("http://locahost:8084/EIMS/clientManage/updataClient.jsp");
}
else{
 try{
	...
	String sql="update client set clientName='"+clientName+ "',clientTelephone='"+clientTelephone+ "',clientAddress='"+ clientAddress + "',clientEmail='"+clientEmail + "' where clientName='"+clientName+"'";
            ...
            response.sendRedirect("http://locahost:8084/EIMS/clientManage/lookClient.jsp");
}
catch (Exception e){
	e.printStackTrace();
}
