...
new String(request.getParameter("clientTelephone").getBytes("ISO-8859-1"),"utf-8");
String clientAddress=
new String(request.getParameter("clientAddress").getBytes("ISO-8859-1"),"utf-8");
String clientEmail=
new String(request.getParameter("clientEmail").getBytes("ISO-8859-1"),"utf-8");
Connection con=null;
Statement st=null;
try{
